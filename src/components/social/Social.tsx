export const Social = () => {
  return (<ul className="list-none marker:text-blue-500 mb-4">
          <li className="m-2 flex items-center justify-center">
            <a href="https://discord.gg/TrVJMwzjKc" target="_blank" rel="noreferrer" 
              className="text-gray-700 dark:text-gray-300 hover:text-indigo-700 mr-2 hover:underline">
              Join our community
          </a>
          ...
          <li className="m-2 flex items-center justify-center">
            <a href="https://twitter.com/PolygonleGame" target="_blank" rel="noreferrer"
              className="text-gray-700 dark:text-gray-300 hover:text-indigo-700 mr-2 hover:underline">
              Follow our twitter
            </a>
